...
var shoppingCart = (function() {
  ...
  // =============================
  //cart = [{"name":"friedRice","price":40,"count":1,"id":10},{"name":"potolVorta","price":10,"count":1,"id":9},{"name":"vunaKhicuri","price":30,"count":1,"id":8},];
...
jQuery(document).ready(function(){
  jQuery('.add-to-cart').on('click', function(){
    ...
    var Ajaxdata = shoppingCart.listCart();
