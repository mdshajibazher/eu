      ...
      <div class="login-page">
        <div class="form">
          ...
          <form class="register-form" style="display: block;text-align: left;" action="" method="POST">
            ...
            <input type="text" placeholder="name" name="name" id="name" value="<?php if(isset($_POST['name'])){ echo $_POST['name']; } ?>"/>

            <?php if(isset($studentDataInsert['name'])){ echo $studentDataInsert['name'];} ?>

            <label for="sid">Student Id</label>
            <input type="text" placeholder="Student Id" name="st_id" id="sid" value="<?php if(isset($_POST['st_id'])){ echo $_POST['st_id']; } ?>" />
            ...
            <input type="text" placeholder="email address" name="email" id="email" value="<?php if(isset($_POST['email'])){ echo $_POST['email']; } ?>"/>
            ...
            <input type="password" placeholder="Enter Password" name="password" id="password" value="<?php if(isset($_POST['password'])){ echo $_POST['password']; } ?>"/>
            ...
            <input type="password" placeholder="Confirm Password" name="conf_password" id="conf_password" value="<?php if(isset($_POST['conf_password'])){ echo $_POST['conf_password']; } ?>" />
            <?php if(isset($studentDataInsert['conf_pass'])){ echo $studentDataInsert['conf_pass'];} ?>
            <label for="addr">Address</label>
            <textarea name="addr"  cols="35" rows="10" placeholder="Enter Your Address" id="addr"><?php if(isset($_POST['addr'])){ echo $_POST['addr']; } ?></textarea>
